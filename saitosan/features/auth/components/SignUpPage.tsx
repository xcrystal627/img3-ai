...
import { useSignUpProvider } from '../providers/useSignUpProvider'

function SignUpPage() {
  const { handleGoogleSignUp } = useSignUpProvider()
      ...
      <div className="mt-7 rounded-xl border border-gray-200 bg-white shadow-sm">
        <div className="p-4 sm:p-7">
          <div className="text-center">
            <h1 className="block text-2xl font-bold text-gray-800">新規登録</h1>
